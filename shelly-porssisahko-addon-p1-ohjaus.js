...
//  apw = 4000;
    if (cmd) {
      if (charger_on) { //when charger is on
        if (apw >= charger + limit) {
          console.log("Apw usage " + apw + " over or at limit " + (charger + limit) + ", charger goes OFF.");
          cmd = false;
          charger_on = false;
          }
        else {
          console.log("Apw usage " + apw + " under limit " + (charger + limit) + ", charger stays ON.");
          } 
        }
      else { //when charger is off
        if (apw < limit) {
          console.log("Apw usage " + apw + " under limit " + limit + ", charger goes ON.");
          charger_on = true;
          }
        else {          
          console.log("Apw usage " + apw + " over or at limit " + limit + ", charger stays OFF.");
          cmd = false;
          }
        }
    } 
